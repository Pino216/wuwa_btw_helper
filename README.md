...
**Q: 最新版本有哪些重要更新？**  
A: v1.6版本主要更新包括：1) 算法评分归一化改进；2) 移除了动态算法切换功能；3) 增强了综合推荐算法的自定义选项；4) 进一步优化了蒙特卡洛算法的性能；5) 改进了批量模拟的界面和性能对比。
...
- **动态算法切换已被移除**，因为实际使用中发现手动选择算法能提供更可控的体验
